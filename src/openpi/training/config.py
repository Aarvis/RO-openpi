    ...
    TrainConfig(
        ...
        data=OrigamiCompActionChunkDataConfig(
            ...
            manifest_build=OrigamiCompActionChunkManifestBuildConfig(
                ...
                speed_alpha=2.2,
                speed_min_weight=0.8,
                speed_max_weight=1.2,
    ...
    dataclasses.replace(
        ...
        data=dataclasses.replace(
            ...
            manifest_build=dataclasses.replace(
                ...
                train_planner_view_modes=("frame_stride_25", "random_mix"),
                val_planner_view_modes=("frame_stride_25", "random_mix"),
                planner_value_variant="raw",
        ...
        weight_loader=weight_loaders.CheckpointWeightLoader(
            ...
            "/home/jl_fs/RO-openpi/DUME-NO-PLANNER-100-COMP-ACTION-CHUNK/params"
        ),
        lr_schedule=_optimizer.CosineDecaySchedule(
            warmup_steps=500,
            peak_lr=3e-5,
        ...
        batch_size=32,
        num_workers=20,
        num_train_steps=87_500,
        checkpoint_strategy="manual",
        save_steps=(1000, 20_000, 40_000, 60_000),
        # save_interval=5_000,
        # keep_period=10_000,
        max_to_keep=20,
    )
