...
_CONFIGS = [
    ...
    TrainConfig(
        # Short bring-up config to isolate base flow-matching stability without any spline auxiliary losses.
        name="pi05_origami_checkpoint_spline_vla_no_aux_smoketest",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_dim=65,
            state_dim=65,
            ...
            origami_vla=pi0_config.OrigamiVlaConfig(
                ...
                curve_sample_count=120,
                smooth_l1_beta=0.05,
                curve_loss_weight=0.0,
                start_loss_weight=0.0,
                end_loss_weight=0.0,
                width_loss_weight=0.0,
                width_min=1e-4,
                use_quantile_norm=True,
            ),
        ),
